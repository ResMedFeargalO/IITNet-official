...
def filter_down(eeg_data, lowcut=.05, highcut=16, order=50, sample_in=100, sample_out=32):
...
def main():
    ...
    for i in range(len(psg_fnames)):
        ...
        # Generate label and remove indices32
        ...
        #raw_ch=filter_down(eeg_data=raw_ch.reshape(-1,),lowcut=.05, highcut=16, order=50, sample_in=32, sample_out=100)
        #sampling_rate=32
